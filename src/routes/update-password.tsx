    ...
    <div className="min-h-screen relative flex items-center justify-center bg-background text-foreground overflow-hidden">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground mt-1.5">
          {done ? "Your password has been changed successfully." : "Choose a strong new password for your account."}
        </p>
        ...
        <div className="panel p-6 mt-6">
          {done ? (
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <Button asChild className="w-full bg-primary text-primary-foreground hover:bg-primary/90 ember-glow">
            ...
            <form onSubmit={submit} className="space-y-3">
              <div className="space-y-1.5">
                <Label htmlFor="pw" className="text-[10px] tick uppercase tracking-[0.18em] text-muted-foreground">New password</Label>
              ...
              <div className="space-y-1.5">
                <Label htmlFor="confirm" className="text-[10px] tick uppercase tracking-[0.18em] text-muted-foreground">Confirm password</Label>
                <Input id="confirm" type="password" required minLength={6} value={confirm} onChange={(e) => setConfirm(e.target.value)} className="bg-background/40" />
              </div>
